          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-8 col-sm-7 text-align-right">
                         ...
                         <span class="instagram"><i class="fa fa-instagram"></i> <a href="https://www.instagram.com/drapaulazanoti?igsh=aXF0NHB4eG05ZXk0">Dr.Paula</a></span>
                    </div>
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="{{ route('make') }}"class="smoothScroll">Contact</a></li>
